	...
	<div class="row">
		<div>
			<form class="form-userdata" action="/Userprofile/update" method="POST">
				...
				<input type="text" name="inputFirstName" placeholder="<?php echo $user->firstname; ?>" id="inputFirstname" class="form-control" title="">

				<label for="inputAchternaam" class="sr-only">Achternaam</label>
				<input type="text" name="inputLastName" placeholder="<?php echo $user->lastname; ?>" id="inputLastname" class="form-control" title="">

				<label for="inputEmail" class="sr-only">E-Mail adres</label>
				<input type="email" name="inputEMail" placeholder="<?php echo $user->email; ?>" id="inputEmail" class="form-control" value="" title="">
				<label for="inputEmailConfirm" class="sr-only">E-Mail adres bevestiging</label>
				<input type="email" name="inputEMailConfirm" placeholder="E-Mail bevestiging" id="inputEmailConfirm" class="form-control" value="" title="">

    			<label for="inputPassword" class="sr-only">Wachtwoord</label>
				<input type="password" name="inputPassword" placeholder="Wachtwoord" id="inputPassword" class="form-control" title="">
        		<label for="inputPasswordConfirm" class="sr-only">Bevestig wachtwoord</label>
				<input type="password" name="inputPasswordConfirm" placeholder="Wachtwoord bevestiging" id="inputPasswordConfirm" class="form-control" title="" onchange="checkPass();">
