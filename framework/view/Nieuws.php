		...
		<div class="row">
			<div class="col-md-12">
				<ol class="breadcrumb">
					...
					<li class="active">Nieuw Plantsoen</li>
				</ol>
			</div>
		</div>
		...
		<div class="row">
			<div class="col-md-12">
				<div class="page-header">
					<h1>Nieuw Plantsoen <small>Een nieuw plantsoen voor iedereen!</small></h1>
				</div>
			</div>
		</div>
		...
		<div class="row">
			<div class="col-md-9">
				<div class="embed-responsive embed-responsive-16by9">
					<iframe class="embed-responsive-item" src="https://www.youtube.com/embed/JGYJIEBgQi8" allowfullscreen></iframe>
				</div>
				<hr>

				<div class="blog-post">
				<p class="blog-post-meta">January 1, 2015 by <a href="#">Jan Janssen</a></p>
				<hr>
			...
			<div class="col-md-3">
				<ul class="list-group">
					...
					tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam... <a href="btn btn-default">Lees meer <span class="glyphicon glyphicon-chevron-right"></span></a></li>
					<li class="list-group-item">Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod
					tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam... <a href="btn btn-default">Lees meer <span class="glyphicon glyphicon-chevron-right"></span></a></li>
					<li class="list-group-item">Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod
					tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam... <a href="btn btn-default">Lees meer <span class="glyphicon glyphicon-chevron-right"></span></a></li>
