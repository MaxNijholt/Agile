...
<?php
header('http://bram.tjosti.nl/Agile/');
...
class Registervalidation extends core\Controller {
	...
	private function registerUser() {
		...
		//echo '<script type="text/javascript">
         //  window.location = "?q=Registionvalidation"
      	//</script>';

      	$this->load->view('Registervalidation', array(
