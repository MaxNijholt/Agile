		...
		<div class="row">
			<div class="col-md-12">
				<ol class="breadcrumb">
					...
					<li><a href="discussie.php">Discussie</a></li>
					<li class="active">Bushalte De Bunders</li>
				</ol>
			</div>
		</div>
		...
		<div class="row">
			<div class="col-md-12">
				<div class="page-header">
					<h1>Bushalte De Bunders <small>Blijven of verdwijnen?</small></h1>
				</div>
			</div>
		</div>
				...
				<ul class="media-list">
					<li class="media">
						...
						<div class="media-body">
							<h4 class="media-heading">Henk de Vries</h4>
							<p>
							...
							<div class="media">
								...
								<div class="media-body">
									<h4 class="media-heading">Jan Janssen</h4>
									Cras sit amet nibh libero, in gravida nulla. Nulla vel metus scelerisque ante sollicitudin commodo. Cras purus odio, vestibulum in vulputate at, tempus viverra turpis.
									<!-- Nested media object -->				
									<div class="media">
										<div class="media-left">
							...
							<div class="media">
								...
								<div class="media-body">
									<h4 class="media-heading">Kenny Rogers</h4>
									Cras sit amet nibh libero, in gravida nulla. Nulla vel metus scelerisque ante sollicitudin commodo. Cras purus odio, vestibulum in vulputate at, tempus viverra turpis.
								</div>
							</div>
						</div>
